...
<xsl:stylesheet 
  ...
  <xsl:template match="/bs:roster">
    <html>
      <head>
        <title><xsl:value-of select="/bs:roster/@name" /></title>
        <style>
          body {
  ...
  <xsl:template match="bs:costs/bs:cost">
  ...
  <xsl:template name="unit-card">
    <div class="unit">
      <xsl:call-template name="unit-stats" />
      <xsl:call-template name="ranged-weapons" />
      <xsl:call-template name="melee-weapons" />
      <xsl:call-template name="psychic-powers" />
      <xsl:call-template name="equipment" />
      <xsl:call-template name="special-rules" />
    </div>
  </xsl:template>

  <xsl:template name="unit-stats">
    <div>
      <h1>
        <xsl:value-of select="./@name" />         
      </h1>
      <div class="titled-pane">
        <xsl:variable name="model-count" select=".//bs:selection[starts-with(@name, 'Single Unit')]/@name | .//bs:selection[starts-with(@name, 'Combined Unit')]/@name" />
        <h2>
          <xsl:choose>
            <xsl:when test="$model-count != ''">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td><xsl:value-of select=".//bs:profiles/bs:profile[@typeName='Unit']/bs:characteristics/bs:characteristic[@name='Quality']" /></td>
              <td><xsl:value-of select=".//bs:profiles/bs:profile[@typeName='Unit']/bs:characteristics/bs:characteristic[@name='Defense']" /></td>
              <td>
                <xsl:choose>
      ...
      <table>
        ...
        <xsl:for-each select=".//bs:profiles/bs:profile[@typeName='Ranged Weapon']">
          <tr>
            ...
            <td>
              <xsl:choose>
                <xsl:when test="bs:characteristics/bs:characteristic[@name='Special Rules'] != ''">
                  <xsl:value-of select="bs:characteristics/bs:characteristic[@name='Special Rules']" />
                </xsl:when>
                <xsl:otherwise>
                  -
                </xsl:otherwise>
  ...
  <xsl:template name="psychic-powers">
    <xsl:if test=".//bs:profiles/bs:profile[@typeName='Psychic Power'] != ''">
    <div class="psychic-powers titled-pane">
      ...
      <table>
        ...
        <tbody>
        <xsl:for-each select=".//bs:profiles/bs:profile[@typeName='Psychic Power']">
          <xsl:sort select="@name" />
          <tr>
            <td><xsl:value-of select="@name" /></td>
            <td><xsl:value-of select="bs:characteristics/bs:characteristic[@name='Roll']" /></td>
            <td><xsl:value-of select="bs:characteristics/bs:characteristic[@name='Details']" /></td>
          </tr>
        </xsl:for-each>
        </tbody>
      </table>
  ...
  <xsl:template name="special-rules">
    <xsl:if test=".//bs:rules != ''">
    <div class="special-rules titled-pane">
      <h2>Special Rule Explanations</h2>
      <table>
        <thead>
          <tr>
            <th>Name</th>
  ...
  <xsl:template name="equipment">
    <xsl:if test=".//bs:profile[@typeName='Equipment'] != ''">
    <div class="equipment titled-pane">
      <h2>Equipment, Conditions, and Additional Abilities</h2>
      <table>
        <thead>
          <tr>
            <th>Name</th>
        ...
        <tbody>
        <xsl:for-each select=".//bs:profile[@typeName='Equipment']">
          <tr>
            <td><xsl:value-of select="@name" /></td>
            <td><xsl:value-of select=".//bs:characteristics/bs:characteristic" /></td>
          </tr>
        </xsl:for-each>
        <!-- <xsl:for-each select="">
        </xsl:for-each> -->
